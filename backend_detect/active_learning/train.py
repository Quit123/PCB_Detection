...
from backend.pre import split_dataset, batch_convert
import itertools
...
if __name__ == '__main__':
    ...
    for param in param_list:
        ...
        args = dict(
            model="../runs/train-2/exp_h0.015_s0.5_v0.4_d15_t0.05_sc0.5_sh2.5_m0.001/weights/best.pt",
            data="./next_train.yaml",
            epochs=100,
            batch=2,
            project='../runs/activa_learning',
            name=param['name'],
            hsv_h=param['hsv_h'],
            hsv_s=param['hsv_s'],
            hsv_v=param['hsv_v'],
